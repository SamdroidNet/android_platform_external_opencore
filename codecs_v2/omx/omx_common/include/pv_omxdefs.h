...
#define MAX_SUPPORTED_COMPONENTS 25 		// e.g. 10 = PV -MP4, PV-H263, PV-AVC, PV-WMV, PV-AAC, PV-AMR, PV-MP3, ...
/* Number of components that can be instantiated is same as the Components available */
#define MAX_INSTANTIATED_COMPONENTS MAX_SUPPORTED_COMPONENTS
