...
#define G729_TIMESTAMP_H_INCLUDED

#ifndef OSCL_BASE_H_INCLUDED
#include "oscl_base.h"
#endif

#define DEFAULT_SAMPLING_FREQ_G729 8000
#define DEFAULT_SAMPLES_PER_FRAME_G729 80

class G729TimeStampCalc
{
    public:

        G729TimeStampCalc()
        {
            iSamplingFreq = DEFAULT_SAMPLING_FREQ_G729;
            iCurrentTs = 0;
            iCurrentSamples = 0;
...
#endif	//#ifndef G729_TIMESTAMP_H_INCLUDED
