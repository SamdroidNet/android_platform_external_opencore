...
typedef struct ComponentPortType
{
    ...
    OMX_AUDIO_PARAM_AC3TYPE			AudioAc3Param;
    OMX_AUDIO_PARAM_G711TYPE		AudioG711Param;
    OMX_AUDIO_PARAM_EVRCTYPE		AudioEvrcParam;
    OMX_AUDIO_PARAM_G729TYPE		AudioG729Param;
...
class OmxComponentAudio : public OmxComponentBase
{
    public:
	 ...
	 virtual void UpdateAACStreamFormat(OMX_AUDIO_AACSTREAMFORMATTYPE aAACStreamFormat)
        {
            OSCL_UNUSED_ARG(aAACStreamFormat);
        }
};
