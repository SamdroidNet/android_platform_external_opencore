...
OSCL_EXPORT_REF OMX_ERRORTYPE EvrcOmxComponentFactory(OMX_OUT OMX_HANDLETYPE* pHandle, OMX_IN  OMX_PTR pAppData, OMX_PTR pProxy, OMX_STRING aOmxLibName, OMX_PTR &aOmxLib, OMX_PTR aOsclUuid, OMX_U32 &aRefCount)
{
    ...
    OpenmaxEvrcAO* pOpenmaxAOType;
    OMX_ERRORTYPE Status;


    // move InitevrcOmxComponentFields content to actual constructor

    pOpenmaxAOType = (OpenmaxEvrcAO*) OSCL_NEW(OpenmaxEvrcAO, ());
...
OSCL_EXPORT_REF OMX_ERRORTYPE EvrcOmxComponentDestructor(OMX_IN OMX_HANDLETYPE pHandle, OMX_PTR &aOmxLib, OMX_PTR aOsclUuid, OMX_U32 &aRefCount)
{
	OSCL_UNUSED_ARG(aOmxLib);
    OSCL_UNUSED_ARG(aOsclUuid);
    OSCL_UNUSED_ARG(aRefCount);
    ...
    OpenmaxEvrcAO* pOpenmaxAOType = (OpenmaxEvrcAO*)((OMX_COMPONENTTYPE*)pHandle)->pComponentPrivate;
...
class EvrcOmxSharedLibraryInterface: public OsclSharedLibraryInterface,
            public OmxSharedLibraryInterface
{
    public:
        static EvrcOmxSharedLibraryInterface *Instance()
        {
            static EvrcOmxSharedLibraryInterface omxinterface;
            return &omxinterface;
        };

        OsclAny *QueryOmxComponentInterface(const OsclUuid& aOmxTypeId, const OsclUuid& aInterfaceId)
        {
            if (PV_OMX_EVRCDEC_UUID == aOmxTypeId)
            {
                if (PV_OMX_CREATE_INTERFACE == aInterfaceId)
                {
                    return ((OsclAny*)(&EvrcOmxComponentFactory));
                }
                else if (PV_OMX_DESTROY_INTERFACE == aInterfaceId)
                {
                    return ((OsclAny*)(&EvrcOmxComponentDestructor));
                }
            }
            return NULL;
        };
...
extern "C"
{
    ...
    {
        return EvrcOmxSharedLibraryInterface::Instance();
    }
}
...
OMX_ERRORTYPE OpenmaxEvrcAO::ConstructComponent(OMX_PTR pAppData, OMX_PTR pProxy)
{
    ...
    iOmxComponent.SendCommand = OpenmaxEvrcAO::BaseComponentProxySendCommand;
    iOmxComponent.GetParameter = OpenmaxEvrcAO::BaseComponentProxyGetParameter;
    iOmxComponent.SetParameter = OpenmaxEvrcAO::BaseComponentProxySetParameter;
    iOmxComponent.GetConfig = OpenmaxEvrcAO::BaseComponentProxyGetConfig;
    iOmxComponent.SetConfig = OpenmaxEvrcAO::BaseComponentProxySetConfig;
    iOmxComponent.GetExtensionIndex = OpenmaxEvrcAO::BaseComponentProxyGetExtensionIndex;
    iOmxComponent.GetState = OpenmaxEvrcAO::BaseComponentProxyGetState;
    iOmxComponent.UseBuffer = OpenmaxEvrcAO::BaseComponentProxyUseBuffer;
    iOmxComponent.AllocateBuffer = OpenmaxEvrcAO::BaseComponentProxyAllocateBuffer;
    iOmxComponent.FreeBuffer = OpenmaxEvrcAO::BaseComponentProxyFreeBuffer;
    iOmxComponent.EmptyThisBuffer = OpenmaxEvrcAO::BaseComponentProxyEmptyThisBuffer;
    iOmxComponent.FillThisBuffer = OpenmaxEvrcAO::BaseComponentProxyFillThisBuffer;

#else
    iPVCapabilityFlags.iIsOMXComponentMultiThreaded = OMX_FALSE;

    iOmxComponent.SendCommand = OpenmaxEvrcAO::BaseComponentSendCommand;
    iOmxComponent.GetParameter = OpenmaxEvrcAO::BaseComponentGetParameter;
    iOmxComponent.SetParameter = OpenmaxEvrcAO::BaseComponentSetParameter;
    iOmxComponent.GetConfig = OpenmaxEvrcAO::BaseComponentGetConfig;
    iOmxComponent.SetConfig = OpenmaxEvrcAO::BaseComponentSetConfig;
    iOmxComponent.GetExtensionIndex = OpenmaxEvrcAO::BaseComponentGetExtensionIndex;
    iOmxComponent.GetState = OpenmaxEvrcAO::BaseComponentGetState;
    iOmxComponent.UseBuffer = OpenmaxEvrcAO::BaseComponentUseBuffer;
    iOmxComponent.AllocateBuffer = OpenmaxEvrcAO::BaseComponentAllocateBuffer;
    iOmxComponent.FreeBuffer = OpenmaxEvrcAO::BaseComponentFreeBuffer;
    iOmxComponent.EmptyThisBuffer = OpenmaxEvrcAO::BaseComponentEmptyThisBuffer;
    iOmxComponent.FillThisBuffer = OpenmaxEvrcAO::BaseComponentFillThisBuffer;
#endif

    iOmxComponent.SetCallbacks = OpenmaxEvrcAO::BaseComponentSetCallbacks;
    ...
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->PortParam.format.audio.cMIMEType = (OMX_STRING)"audio/evrc";
    ...
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->PortParam.format.audio.eEncoding = OMX_AUDIO_CodingEVRC;
    ...
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->PortParam.nBufferCountActual = NUMBER_INPUT_BUFFER_EVRC;
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->PortParam.nBufferCountMin = 1;
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->PortParam.nBufferSize = INPUT_BUFFER_SIZE_EVRC;
    ...
    //Set to a default value, will change later during setparameter call
    ipPorts[OMX_PORT_OUTPUTPORT_INDEX]->PortParam.nBufferCountActual = NUMBER_OUTPUT_BUFFER_EVRC;
    ipPorts[OMX_PORT_OUTPUTPORT_INDEX]->PortParam.nBufferCountMin = 1;
    ipPorts[OMX_PORT_OUTPUTPORT_INDEX]->PortParam.nBufferSize = OUTPUT_BUFFER_SIZE_EVRC * 6;
    ...
    //Default values for EVRC audio param port
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.nPortIndex = OMX_PORT_INPUTPORT_INDEX;
    ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.nChannels = 1;
    //ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.nBitRate = 0;
    //ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.nSampleRate = 8000;
    //ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.nAudioBandWidth = 0;
    //ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.eChannelMode = OMX_AUDIO_ChannelModeStereo;
   //ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam.eFormat = OMX_AUDIO_EvrcStreamFormatMP1Layer3;
   ...
   ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEqualizerType.nPortIndex = OMX_PORT_INPUTPORT_INDEX;
    ...
    pInPort->AudioParam.eEncoding = OMX_AUDIO_CodingEVRC;
    ...
    iOutputFrameLength = OUTPUT_BUFFER_SIZE_EVRC;

    if (ipEvrcDec)
    {
        OSCL_DELETE(ipEvrcDec);
        ipEvrcDec = NULL;
    }

    ipEvrcDec = OSCL_NEW(OmxEvrcDecoder, ());
    if (ipEvrcDec == NULL)
    {
        return OMX_ErrorInsufficientResources;
    }

    oscl_memset(ipEvrcDec, 0, sizeof(OmxEvrcDecoder));
...
OMX_ERRORTYPE OpenmaxEvrcAO::DestroyComponent()
{
...
void OpenmaxEvrcAO::SyncWithInputTimestamp()
{
...
void OpenmaxEvrcAO::ResetComponent()
{
    // reset decoder
    if (ipEvrcDec)
    {
        ipEvrcDec->ResetDecoder();
        //Set this length to zero for flushing the current input buffer
    	ipEvrcDec->iInputUsedLength = 0;
    	//ipEvrcDec->iInitFlag = 0;
    }
}


void OpenmaxEvrcAO::ProcessInBufferFlag()
{
    iIsInputBufferEnded = OMX_FALSE;
}

void OpenmaxEvrcAO::ProcessData()
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData IN"));
    ...
    if ((!iIsInputBufferEnded) || iEndofStream)
    {
        ...
        if (OMX_TRUE == iNewOutBufRequired)
        {
            ...
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData OUT output buffer unavailable"));
                return;
            }
            ...
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData Error, Output Buffer Dequeue returned NULL, OUT"));
                return;
            }
        ...
        DecodeReturn = ipEvrcDec->EvrcDecodeFrame((OMX_S16*) pOutBuffer,
                                                (OMX_U32*) & OutputLength,
                                                (OMX_S16**)(&(ipFrameDecodeBuffer)),
                                                &iInputCurrLength,
                                                &iFrameCount,
                                                &(ipPorts[OMX_PORT_OUTPUTPORT_INDEX]->AudioPcmMode),
                                                &(ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEvrcParam),
                                                iEndOfFrameFlag,
                                                &ResizeNeeded);
        ...
        if (ResizeNeeded == OMX_TRUE)
        {
            ...
            if ((NULL == ipTempOutBufferForPortReconfig))
            {
                ...
                if (NULL == ipTempOutBufferForPortReconfig)
                {
                    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData error, insufficient resources"));
                    return;
                }
            }
        ...
        if (OMX_TRUE == iEndofStream)
        {
             ...
             */
			if (EVRCDEC_SUCCESS != DecodeReturn)
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData EOS callback send"));
                ...
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData OUT"));
        ...
        else if (EVRCDEC_INCOMPLETE_FRAME == DecodeReturn)
        {
        ...
        else
        {
            ...
            PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ProcessData ErrorStreamCorrupt callback send"));
...
void OpenmaxEvrcAO::ComponentGetRolesOfComponent(OMX_STRING* aRoleString)
{
    *aRoleString = (OMX_STRING)"audio_decoder.evrc";
}

//Active object constructor
OpenmaxEvrcAO::OpenmaxEvrcAO()
{
    ipEvrcDec = NULL;
    ...
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : constructed"));
}
...
OpenmaxEvrcAO::~OpenmaxEvrcAO()
{
    ...
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : destructed"));
}

/** The Initialization function
 */
OMX_ERRORTYPE OpenmaxEvrcAO::ComponentInit()
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ComponentInit IN"));

    OMX_BOOL Status = OMX_FALSE;

    if (OMX_TRUE == iIsInit)
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ComponentInit error incorrect operation"));
    ...
    if (!iCodecReady)
    {
        //Status = ipEvrcDec->EvrcDecInit(&(ipPorts[OMX_PORT_INPUTPORT_INDEX]->AudioEqualizerType));
        Status = ipEvrcDec->EvrcDecInit();
    ...
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ComponentInit OUT"));
 ...
 *  Also it is called by the EvrcComponentDestructor() function
 */
OMX_ERRORTYPE OpenmaxEvrcAO::ComponentDeInit()
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ComponentDeInit IN"));

    iIsInit = OMX_FALSE;

    if (iCodecReady)
    {
        ipEvrcDec->EvrcDecDeinit();
        iCodecReady = OMX_FALSE;
    }

    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : ComponentDeInit OUT"));
...
void OpenmaxEvrcAO::CheckForSilenceInsertion()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : CheckForSilenceInsertion OUT - No need to insert silence"));
        return;
    }
    ...
    if (iFrameCount > 0)
    {
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : CheckForSilenceInsertion OUT - Silence Insertion required here"));
    }
...
void OpenmaxEvrcAO::DoSilenceInsertion()
{
    QueueType* pOutputQueue = ipPorts[OMX_PORT_OUTPUTPORT_INDEX]->pBufferQueue;
    ComponentPortType* pOutPort = ipPorts[OMX_PORT_OUTPUTPORT_INDEX];
    ...
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : DoSilenceInsertion IN"));
    ...
    while (iSilenceFramesNeeded > 0)
    {
        ...
        if (OMX_TRUE == iNewOutBufRequired)
        {
            ...
            if (0 == (GetQueueNumElem(pOutputQueue)))
            {
                ...
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : DoSilenceInsertion OUT output buffer unavailable"));
                iSilenceInsertionInProgress = OMX_TRUE;
                return;
            }
            ...
            if (NULL == ipOutputBuffer)
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : DoSilenceInsertion Error, Output Buffer Dequeue returned NULL, OUT"));
                iSilenceInsertionInProgress = OMX_TRUE;
                return;
            }
            ipOutputBuffer->nFilledLen = 0;
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : DoSilenceInsertion - One frame of zeros inserted"));
    ...
    iSilenceInsertionInProgress = OMX_FALSE;
    iCurrentFrameTS.SetFromInputTimestamp(iFrameTimestamp);
    PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "OpenmaxEvrcAO : DoSilenceInsertion OUT - Done successfully"));

    return;
}


OMX_ERRORTYPE OpenmaxEvrcAO::GetConfig(
