...
#define OUTPUT_BUFFER_SIZE_AAC 8192 /* SAMPLES_PER_FRAME(LC 1024, HE 2048) * Channels(2) * BytesPerSample(2) */

#define NUMBER_INPUT_BUFFER_AAC  5
#define NUMBER_OUTPUT_BUFFER_AAC 4
