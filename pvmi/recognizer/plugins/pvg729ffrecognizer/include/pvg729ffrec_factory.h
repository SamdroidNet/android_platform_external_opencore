 ...
 * -------------------------------------------------------------------
 */
#ifndef PVG729FFREC_FACTORY_H_INCLUDED
#define PVG729FFREC_FACTORY_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

class PVG729FFRecognizerFactory : public PVMFRecognizerPluginFactory
{
    public:
        PVG729FFRecognizerFactory()
        {
        };
...
#endif // PVG729FFREC_FACTORY_H_INCLUDED
