 ...
 * -------------------------------------------------------------------
 */
#ifndef PVG729FFREC_PLUGIN_H_INCLUDED
#define PVG729FFREC_PLUGIN_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

#define G729FF_MIN_DATA_SIZE_FOR_RECOGNITION 7

class PVG729FFRecognizerPlugin : public PVMFRecognizerPluginInterface
{
    public:
        PVG729FFRecognizerPlugin()
        {
        };
...
#endif // PVG729FFREC_PLUGIN_H_INCLUDED
