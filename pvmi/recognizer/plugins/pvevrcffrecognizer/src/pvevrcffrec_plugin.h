 ...
 * -------------------------------------------------------------------
 */
#ifndef PVEVRCFFREC_PLUGIN_H_INCLUDED
#define PVEVRCFFREC_PLUGIN_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

#define EVRCFF_MIN_DATA_SIZE_FOR_RECOGNITION 6

class PVEVRCFFRecognizerPlugin : public PVMFRecognizerPluginInterface
{
    public:
        PVEVRCFFRecognizerPlugin()
        {
        };
...
#endif // PVEVRCFFREC_PLUGIN_H_INCLUDED
