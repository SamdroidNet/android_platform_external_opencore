 ...
 * -------------------------------------------------------------------
 */
#ifndef PVEVRCFFREC_FACTORY_H_INCLUDED
#define PVEVRCFFREC_FACTORY_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

class PVEVRCFFRecognizerFactory : public PVMFRecognizerPluginFactory
{
    public:
        PVEVRCFFRecognizerFactory()
        {
        };
...
#endif // PVEVRCFFREC_FACTORY_H_INCLUDED
