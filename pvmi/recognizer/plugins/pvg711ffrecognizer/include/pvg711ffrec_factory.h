 ...
 * -------------------------------------------------------------------
 */
#ifndef PVG711FFREC_FACTORY_H_INCLUDED
#define PVG711FFREC_FACTORY_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

class PVG711FFRecognizerFactory : public PVMFRecognizerPluginFactory
{
    public:
        PVG711FFRecognizerFactory()
        {
        };
...
#endif // PVG711FFREC_FACTORY_H_INCLUDED
