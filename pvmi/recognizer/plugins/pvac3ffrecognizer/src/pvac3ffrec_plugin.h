 ...
 * -------------------------------------------------------------------
 */
#ifndef PVAC3FFREC_PLUGIN_H_INCLUDED
#define PVAC3FFREC_PLUGIN_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

#define AC3FF_MIN_DATA_SIZE_FOR_RECOGNITION 5

class PVAC3FFRecognizerPlugin : public PVMFRecognizerPluginInterface
{
    public:
        PVAC3FFRecognizerPlugin()
        {
        };
...
#endif // PVAC3FFREC_PLUGIN_H_INCLUDED
