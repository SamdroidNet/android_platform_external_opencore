 ...
 * -------------------------------------------------------------------
 */
#ifndef PVAC3FFREC_FACTORY_H_INCLUDED
#define PVAC3FFREC_FACTORY_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

class PVAC3FFRecognizerFactory : public PVMFRecognizerPluginFactory
{
    public:
        PVAC3FFRecognizerFactory()
        {
        };
...
#endif // PVAC3FFREC_FACTORY_H_INCLUDED
