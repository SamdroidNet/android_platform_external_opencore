/* ------------------------------------------------------------------
 * Copyright (C) 2009 Samsung Electorinics
 *
 ...
 */
/**
 * @file smp4fm_oc_clipconfig.h
 * @brief Clip level configuration of SMp4MuxNode
 */

#ifndef __SMP4FM_OC_CLIPCONFIG_H_3729934589124693490__
#define __SMP4FM_OC_CLIPCONFIG_H_3729934589124693490__
...
#include "pvmi_kvp.h"
#include "oscl_file_io.h"	/* Added for opencore 2.03 */


#define SMp4fmOcClipCfgUuid PVUuid(0xd24c9b6c,0x8e30,0x433b,0x97,0x42,0xd9,0x0f,0x74,0x13,0xb1,0x50)
...
typedef enum
{
	...
	*/
	SMP4FM_OC_3GPP_PROGRESSIVE_DOWNLOAD_MODE = 0x00000003,
	...
	*/
	SMP4FM_OC_3GPP_DOWNLOAD_MODE = 0x00000009,
	...
	* Temporary files are written to the same directory as the output file.
	*/
	SMP4FM_OC_IMOTION_PSEUDO_STREAMING_MODE = 0x00000007,
	...
	*/
	SMP4FM_OC_IMOTION_DOWNLOAD_MODE = 0x0000000D,
	...
	* No temp files are used.
	*/
	SMP4FM_OC_MOVIE_FRAGMENT_MODE = 0x00000021
} SMp4fmOcAuthoringMode;

/**
 * SMp4fmClipCfgIf allows a client to control 
 * properties of PVMp4FFComposerNode
 */
class SMp4fmOcClipCfgIf : public PVInterface
{
public:
	/**
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetAuthoringMode(SMp4fmOcAuthoringMode aAuthoringMode = SMP4FM_OC_3GPP_DOWNLOAD_MODE) = 0;

	/**
	* Method to set the sample rate (i.e. timescale) for the overall 
	* Mpeg-4 presentation.
	* This is an optional configuration API that should be called before 
	* Start() is called.
	*
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetVersion(const OSCL_wString& aVersion, 
								const OSCL_String& aLangCode) = 0;
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetTitle(const OSCL_wString& aTitle, 
								const OSCL_String& aLangCode) = 0;
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetAuthor(const OSCL_wString& aAuthor, 
								const OSCL_String& aLangCode) = 0;
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetCopyright(const OSCL_wString& aCopyright, 
									const OSCL_String& aLangCode) = 0;
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetDescription(const OSCL_wString& aDescription, 
									const OSCL_String& aLangCode) = 0;
	...
	*/
	/* This is an optional configuration API that should be called 
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetRating(const OSCL_wString& aRating, 
								const OSCL_String& aLangCode) = 0;
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetAlbumInfo(const OSCL_wString& aAlbum_Title, 
									const OSCL_String& aLangCode) = 0;
	/* This is an optional configuration API that should be called before 
	*  Start() is called.
	*
	...
	*/
	...
	/**
	* This method populates the performer string. Performer string contains 
	* information about the the performer of the clip.
	* Currently only wide char strings are supported.
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetPerformer(const OSCL_wString& aPerformer, 
									const OSCL_String& aLangCode) = 0;

	/**
	* This method populates the genre string. Genre string contains 
	* information about the the genre of the clip.
	* Currently only wide char strings are supported.
	* Language code is currently used only in case of IMOTION authoring mode,
	* to populate the IMOTION author info atom.
	*
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetGenre(const OSCL_wString& aGenre, 
								const OSCL_String& aLangCode) = 0;

	/**
	* This method populates the Classification string. classification string 
	* contains information about the the classification of the clip .
	* Currently only wide char strings are supported.
	* Language code is currently used only in case of IMOTION authoring mode,
	* to populate the IMOTION author info atom.
	*
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetClassification(const OSCL_wString& aClassificationInfo, 
										uint32 aClassificationEntity, 
										uint16 aClassificationTable, 
										const OSCL_String& aLangCode) = 0;
	/**
	* This method populates the keyword string. keyword string contains 
	* information about the the keyword of the clip.
	* Currently only wide char strings are supported.
	* Language code is currently used only in case of IMOTION authoring mode,
	* to populate the IMOTION author info atom.
	*
	...
	* @return Completion status of this method.
	*/
	virtual PVMFStatus SetKeyWord(const OSCL_wString& aKeyWordInfo, 
								const OSCL_String& aLangCode) = 0;
	/**
	* This method populates the LocationInfo string. LocationInfo string 
	* contains information about the the Location of the clip.
	*
	* This is an optional configuration API that should be called before 
	* Start() is called.
	*
	...
	*/
	...
	/**
	* This method pouplates the aLang string. aLang contains the language code 
	* as a heap string and this function is used to convert the lang code into 
	* uint16 format and stores the lang code into the authored media file.
...
#endif /* __SMP4FM_OC_CLIPCONFIG_H_3729934589124693490__ */
