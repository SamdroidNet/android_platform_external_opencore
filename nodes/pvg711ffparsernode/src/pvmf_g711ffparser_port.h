 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_G711FFPARSER_OUTPORT_H_INCLUDED
#define PVMF_G711FFPARSER_OUTPORT_H_INCLUDED
...
typedef OsclMemAllocator PVMFG711ParserNodeAllocator;

#define PVMF_G711PARSERNODE_LOGERROR(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_ERR,m);
#define PVMF_G711PARSERNODE_LOGWARNING(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_WARNING,m);
#define PVMF_G711PARSERNODE_LOGINFOHI(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G711PARSERNODE_LOGINFOMED(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G711PARSERNODE_LOGINFOLOW(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G711PARSERNODE_LOGINFO(m) PVMF_G711PARSERNODE_LOGINFOMED(m)
#define PVMF_G711PARSERNODE_LOGSTACKTRACE(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_STACK_TRACE,m);
#define PVMF_G711PARSERNODE_LOGDATATRAFFIC(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iDataPathLogger,PVLOGMSG_INFO,m);
#define PVMF_G711PARSERNODE_LOGCLOCK(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iClockLogger,PVLOGMSG_INFO,m);
#define PVMF_G711PARSERNODE_LOGBIN(iPortLogger, m) PVLOGGER_LOGBIN(PVLOGMSG_INST_LLDBG, iPortLogger, PVLOGMSG_ERR, m);


class PVMFG711ParserNodeLoggerDestructDealloc : public OsclDestructDealloc
{
    public:
...
class PVG711FFNodeTrackPortInfo : public OsclMemPoolFixedChunkAllocatorObserver,
            public OsclMemPoolResizableAllocatorObserver
{
    public:

        PVG711FFNodeTrackPortInfo()
        {
            iTrackId = -1;
            iPort = NULL;
        ...
        PVG711FFNodeTrackPortInfo(const PVG711FFNodeTrackPortInfo& aSrc) :
        ...
        virtual ~PVG711FFNodeTrackPortInfo()
        {
        }
        ...
        void freechunkavailable(OsclAny* aContextData)
        {
            ...
            PVMF_G711PARSERNODE_LOGINFO((0, "MimeType = %s, freeblockavailable", iTrackMimeType.get_cstr()));
            oQueueOutgoingMessages = true;
            if (iNode)
            {
        ...
        OSCL_HeapString<PVMFG711ParserNodeAllocator> iTrackMimeType;
        ...
        OSCL_HeapString<PVMFG711ParserNodeAllocator> iLogFile;
        bool oFormatSpecificInfoLogged;

        OsclSharedPtr<PVLoggerAppender> iBinAppenderPtr;
};

class PVMFG711FFParserOutPort : public PvmfPortBaseImpl
            , public PvmiCapabilityAndConfig
{
    public:
         ...
         */
        PVMFG711FFParserOutPort(int32 aTag
    ...
    private:
        ...
        PVMFG711FFParserNode* iG711ParserNode;
};

#endif // PVMF_G711FFPARSER_OUTPORT_H_INCLUDED
