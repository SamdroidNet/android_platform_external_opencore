 ...
 * -------------------------------------------------------------------
 */
#include "pvmf_g711ffparser_node.h"
#include "pvmf_g711ffparser_defs.h"
#include "g711_parsernode_tunables.h"
...
static const char PVG711_ALL_METADATA_KEY[] = "all";
static const char PVG711METADATA_DURATION_KEY[] = "duration";
static const char PVG711METADATA_NUMTRACKS_KEY[] = "num-tracks";
static const char PVG711METADATA_TRACKINFO_BITRATE_KEY[] = "track-info/bit-rate";
static const char PVG711METADATA_TRACKINFO_AUDIO_FORMAT_KEY[] = "track-info/audio/format";
static const char PVG711METADATA_CLIP_TYPE_KEY[] = "clip-type";
static const char PVG711METADATA_RANDOM_ACCESS_DENIED_KEY[] = "random-access-denied";
static const char PVG711METADATA_SEMICOLON[] = ";";
static const char PVG711METADATA_TIMESCALE[] = "timescale=";
static const char PVG711METADATA_INDEX0[] = "index=0";

#define G711_SAMPLE_DURATION 20



PVMFG711FFParserNode::PVMFG711FFParserNode(int32 aPriority) :
        OsclTimerObject(aPriority, "PVG711FFParserNode"),
        iOutPort(NULL),
        iLogger(NULL),
        iG711Parser(NULL),
        iExtensionRefCount(0)
{
    ...
    iG711ParserNodeMetadataValueCount = 0;

    iDownloadProgressInterface = NULL;
    iDownloadFileSize          = 0;
    iG711HeaderSize             = G711_HEADER_SIZE;
    ...
    OSCL_TRY(err,
             ...
             iInputCommands.Construct(PVMF_G711FFPARSER_NODE_COMMAND_ID_START, PVMF_G711FFPARSER_NODE_COMMAND_VECTOR_RESERVE);
             ...
             iCapability.iOutputFormatCapability.push_back(PVMF_MIME_G711);
            );
...
PVMFG711FFParserNode::~PVMFG711FFParserNode()
{
...
PVMFStatus PVMFG711FFParserNode::ThreadLogon()
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::ThreadLogon() Called"));
    if (iInterfaceState == EPVMFNodeCreated)
    {
        ...
        iLogger = PVLogger::GetLoggerObject("PVMFG711ParserNode");
        iDataPathLogger = PVLogger::GetLoggerObject("datapath.sourcenode.g711parsernode");
        iClockLogger = PVLogger::GetLoggerObject("clock");
        iFileServer.Connect();
        SetState(EPVMFNodeIdle);
        return PVMFSuccess;
    }
    PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::ThreadLogon() - Invalid State"));
    return PVMFErrInvalidState;
}

PVMFStatus PVMFG711FFParserNode::GetCapability(PVMFNodeCapability& aNodeCapability)
{

    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::GetCapability() called"));
...
PVMFPortIter* PVMFG711FFParserNode::GetPorts(const PVMFPortFilter* aFilter)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFASFParserNode::GetPorts() called"));
    OSCL_UNUSED_ARG(aFilter);
    PVMF_G711PARSERNODE_LOGERROR((0, "PVMFASFParserNode::GetPorts() Not Implemented"));
    // TODO: Return the currently available ports
    return NULL;
}

PVMFCommandId PVMFG711FFParserNode::QueryUUID(PVMFSessionId s, const PvmfMimeString& aMimeType,
        Oscl_Vector<PVUuid, OsclMemAllocator>& aUuids,
        bool aExactUuidsOnly, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::QueryUUID called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s,
...
PVMFCommandId PVMFG711FFParserNode::QueryInterface(PVMFSessionId s, const PVUuid& aUuid,
        PVInterface*& aInterfacePtr,
        const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::QueryInterface called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s,
...
PVMFCommandId PVMFG711FFParserNode::RequestPort(PVMFSessionId s, int32 aPortTag, const PvmfMimeString* aPortConfig, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::RequestPort called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s,
...
PVMFCommandId PVMFG711FFParserNode::ReleasePort(PVMFSessionId s, PVMFPortInterface& aPort, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::ReleasePort called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_RELEASEPORT, aPort, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Init(PVMFSessionId s, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::Init called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_INIT, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Prepare(PVMFSessionId s, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::Prepare called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_PREPARE, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Start(PVMFSessionId s, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::Start called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_START, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Stop(PVMFSessionId s, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:Stop"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_STOP, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Pause(PVMFSessionId s, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::Stop called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_PAUSE, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Flush(PVMFSessionId s, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:Flush"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_FLUSH, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::Reset(PVMFSessionId s, const OsclAny* aContext)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::Flush called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_RESET, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::CancelAllCommands(PVMFSessionId s, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:CancelAllCommands"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_CANCELALLCOMMANDS, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::CancelCommand(PVMFSessionId s, PVMFCommandId aCmdId, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:CancelCommand"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(s, PVMF_G711_PARSER_NODE_CANCELCOMMAND, aCmdId, aContext);
    return QueueCommandL(cmd);
}

void PVMFG711FFParserNode::Construct()
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::Construct()"));
    iFileServer.Connect();
    iAvailableMetadataKeys.reserve(4);
    iAvailableMetadataKeys.clear();
}

void PVMFG711FFParserNode::Run()
{
    ...
    {
        PVG711FFNodeTrackPortInfo* trackPortInfoPtr = NULL;

        if (!GetTrackInfo(iOutPort, trackPortInfoPtr))
        {
            PVMF_G711PARSERNODE_LOGERROR((0, "PVG711ParserNode::Run: Error - GetTrackInfo failed"));
            return;
        }
...
PVMFStatus  PVMFG711FFParserNode::ProcessOutgoingMsg(PVG711FFNodeTrackPortInfo* aTrackInfoPtr)
{
    /*
    ...
    */
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::ProcessOutgoingMsg() Called aPort=0x%x", aTrackInfoPtr->iPort));
    PVMFStatus status = aTrackInfoPtr->iPort->Send();
    if (status == PVMFErrBusy)
    {
        /* Connected port is busy */
        aTrackInfoPtr->oProcessOutgoingMessages = false;
        PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::ProcessOutgoingMsg() Connected port is in busy state"));
    }
    else if (status != PVMFSuccess)
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::ProcessOutgoingMsg() - aTrackInfoPtr->iPort->Send() Failed"));
    }
    return status;
}

PVMFStatus PVMFG711FFParserNode::DoGetMetadataKeys(PVMFG711FFNodeCommand& aCmd)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::DoGetNodeMetadataKeys() In"));
...
PVMFStatus
PVMFG711FFParserNode::CompleteGetMetadataKeys(PVMFG711FFNodeCommand& aCmd)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::CompleteGetMetadataKeys Called"));
    PVMFMetadataList* keylistptr = NULL;
    uint32 starting_index;
    int32 max_entries;
    char* query_key;

    aCmd.PVMFG711FFNodeCommand::Parse(keylistptr, starting_index, max_entries, query_key);
    if (keylistptr == NULL)
    {
...
PVMFStatus PVMFG711FFParserNode::DoGetMetadataValues(PVMFG711FFNodeCommand& aCmd)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::DoGetMetadataValues() In"));
    ...
    aCmd.PVMFG711FFNodeCommand::Parse(keylistptr_in, valuelistptr, starting_index, max_entries);
    ...
    if (keylistptr_in->size() == 1)
    {
        if (oscl_strncmp((*keylistptr)[0].get_cstr(),
                         PVG711_ALL_METADATA_KEY,
                         oscl_strlen(PVG711_ALL_METADATA_KEY)) == 0)
        {
    ...
    for (uint32 lcv = 0; lcv < numkeys; lcv++)
    {
        ...
        if (oscl_strcmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_DURATION_KEY) == 0 &&
                iG711FileInfo.iDuration > 0)
        {
            // Movie Duration
            ...
            if (numvalentries > starting_index)
            {
                ...
                oscl_snprintf(timescalestr, 20, ";%s%d", PVG711METADATA_TIMESCALE, iG711FileInfo.iTimescale);
                timescalestr[19] = '\0';
                uint32 duration = Oscl_Int64_Utils::get_uint64_lower32(iG711FileInfo.iDuration);
                int32 retval =
                    PVMFCreateKVPUtils::CreateKVPForUInt32Value(KeyVal,
                            PVG711METADATA_DURATION_KEY,
                            duration,
                            timescalestr);
        ...
        else if (oscl_strcmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_NUMTRACKS_KEY) == 0)
        {
            // Number of tracks
            // Increment the counter for the number of values found so far
            ++numvalentries;
            ...
            {
                uint32 numtracks = 1;
                PVMFStatus retval = PVMFCreateKVPUtils::CreateKVPForUInt32Value(KeyVal, PVG711METADATA_NUMTRACKS_KEY, numtracks);
                if (retval != PVMFSuccess && retval != PVMFErrArgument)
                {
                    break;
                }
        ...
        else if ((oscl_strcmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_TRACKINFO_BITRATE_KEY) == 0) &&
                 iG711FileInfo.iBitrate > 0)
        {
            // Bitrate
            // Increment the counter for the number of values found so far
            ++numvalentries;
            ...
            {
                char indexparam[16];
                oscl_snprintf(indexparam, 16, ";%s", PVG711METADATA_INDEX0);
                indexparam[15] = '\0';
                uint32 bitrate = iG711FileInfo.iBitrate;
                retval = PVMFCreateKVPUtils::CreateKVPForUInt32Value(KeyVal, PVG711METADATA_TRACKINFO_BITRATE_KEY, bitrate, indexparam);
            }
            if (retval != PVMFSuccess && retval != PVMFErrArgument)
            {
                break;
        ...
        else if (oscl_strcmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_RANDOM_ACCESS_DENIED_KEY) == 0)
        {
            /*
             * Random Access
             * Increment the counter for the number of values found so far
            ...
            if (numvalentries > (uint32)starting_index)
            {
                ...
                PVMFStatus retval =
                    PVMFCreateKVPUtils::CreateKVPForBoolValue(KeyVal,
                            PVG711METADATA_RANDOM_ACCESS_DENIED_KEY,
        ...
        else if (oscl_strncmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_CLIP_TYPE_KEY, oscl_strlen(PVG711METADATA_CLIP_TYPE_KEY)) == 0)
        {
            /*
             * Clip Type
             * Increment the counter for the number of values found so far
        ...
        else if (oscl_strcmp((*keylistptr)[lcv].get_cstr(), PVG711METADATA_TRACKINFO_AUDIO_FORMAT_KEY) == 0)
        {
            // Format
            // Increment the counter for the number of values found so far
            ++numvalentries;
            ...
            if (numvalentries > starting_index)
            {
                ...
                retval = PVMFCreateKVPUtils::CreateKVPForCharStringValue(KeyVal,
                               PVG711METADATA_TRACKINFO_AUDIO_FORMAT_KEY, _STRLIT_CHAR(PVMF_MIME_G711), indexparam);
    ...
    iG711ParserNodeMetadataValueCount = (*valuelistptr).size();
...
PVMFStatus PVMFG711FFParserNode::DoSetDataSourcePosition(PVMFG711FFNodeCommand& aCmd)
{
    //file must be parsed
    if (!iG711Parser)
    {
    ...
    aCmd.PVMFG711FFNodeCommand::Parse(targetNPT, actualNPT, actualMediaDataTS, seektosyncpoint, streamID);

    Oscl_Vector<PVG711FFNodeTrackPortInfo, PVMFG711ParserNodeAllocator>::iterator it;
    ...
    *actualMediaDataTS = 0;
    ...
    uint32 timestamp;
    int32 result = iG711Parser->PeekNextTimestamp(&timestamp);
    if (result != g711bitstreamObject::EVERYTHING_OK)
    {
    ...
    *actualMediaDataTS = millisecTS;
    ...
    uint32 durationms = 0;
    uint32 duration = durationms = Oscl_Int64_Utils::get_uint64_lower32(iG711FileInfo.iDuration);
    uint32 timescale = iG711FileInfo.iTimescale;
    ...
    if (targetNPT >= durationms)
    {
        ...
        result = iG711Parser->ResetPlayback(0);
        if (result != g711bitstreamObject::EVERYTHING_OK)
        {
            return PVMFErrResource;
        }
    ...
    // Reposition
    // If new position is past the end of clip, G711 FF should set the position to the last frame
    result = iG711Parser->ResetPlayback(targetNPT);
    if (result != g711bitstreamObject::EVERYTHING_OK)
    {
        if (g711bitstreamObject::END_OF_FILE == result)
        {
            for (uint32 i = 0; i < iSelectedTrackList.size(); ++i)
            {
                iSelectedTrackList[i].iSeqNum = 0;
    ...
    uint32 newtimestamp;
    result = iG711Parser->PeekNextTimestamp(&newtimestamp);
    if (result != g711bitstreamObject::EVERYTHING_OK)
    {
        return PVMFErrResource;
    }
...
PVMFStatus PVMFG711FFParserNode::DoQueryDataSourcePosition(PVMFG711FFNodeCommand& aCmd)
{
    //file must be parsed
    if (!iG711Parser)
    {
    ...
    aCmd.PVMFG711FFNodeCommand::Parse(targetNPT, actualNPT, seektosyncpoint);
    if (actualNPT == NULL)
    {
        return PVMFErrArgument;
    }
    ...
    // Query
    // If new position is past the end of clip, G711 FF should set the position to the last frame
    *actualNPT = iG711Parser->SeekPointFromTimestamp(targetNPT);

    return PVMFSuccess;
}

PVMFStatus PVMFG711FFParserNode::DoSetDataSourceRate(PVMFG711FFNodeCommand& aCmd)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::DoSetDataSourceRate() In"));
    OSCL_UNUSED_ARG(aCmd);
    return PVMFSuccess;
}

bool PVMFG711FFParserNode::SendEndOfTrackCommand(PVG711FFNodeTrackPortInfo& aTrackPortInfo)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::SendEndOfTrackCommand() "));
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::SendEndOfTrackCommand() Failed-- Busy "));
        return false;
    }
...
void PVMFG711FFParserNode::HandlePortActivity(const PVMFPortActivity &aActivity)
{
    ...
    switch (aActivity.iType)
    {
        case PVMF_PORT_ACTIVITY_OUTGOING_MSG:
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                            (0, "PVMFG711FFParserNode::PortActivity: Outgoing Msg"));
            RunIfNotReady();
            break;
        ...
        case PVMF_PORT_ACTIVITY_CONNECTED_PORT_READY:
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                            (0, "PVMFG711FFParserNode::PortActivity: Connected port ready"));
        ...
        case PVMF_PORT_ACTIVITY_OUTGOING_QUEUE_READY:
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                            (0, "PVMFG711FFParserNode::PortActivity: Outgoing Queue ready"));
...
bool PVMFG711FFParserNode::ProcessCommand()
{
    ...
    if (!iCurrentCommand.empty()  && !iInputCommands.front().hipri() && iInputCommands.front().iCmd != PVMF_G711_PARSER_NODE_CMD_CANCEL_GET_LICENSE)
    {
        return false;
    }
    ...
    PVMFG711FFNodeCommand& aCmd = iInputCommands.front();
    ...
    if (aCmd.hipri())
    {
        switch (aCmd.iCmd)
        {
            case PVMF_G711_PARSER_NODE_CANCELALLCOMMANDS:
                DoCancelAllCommands(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_CANCELCOMMAND:
    ...
    else
    {
        ...
        switch (aCmd.iCmd)
        {
            case PVMF_G711_PARSER_NODE_QUERYUUID:
                DoQueryUuid(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_QUERYINTERFACE:
                DoQueryInterface(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_REQUESTPORT:
            {
            ...
            case PVMF_G711_PARSER_NODE_RELEASEPORT:
                DoReleasePort(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_INIT:
            ...
            case PVMF_G711_PARSER_NODE_PREPARE:
                DoPrepare(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_START:
                DoStart(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_STOP:
                DoStop(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_FLUSH:
                DoFlush(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_PAUSE:
                DoPause(aCmd);
                break;

            case PVMF_G711_PARSER_NODE_RESET:
                DoReset(aCmd);
                break;
            ...
            case PVMF_G711_PARSER_NODE_GETNODEMETADATAVALUES:
            {
            ...
            case PVMF_G711_PARSER_NODE_SET_DATASOURCE_POSITION:
            {
            ...
            case PVMF_G711_PARSER_NODE_QUERY_DATASOURCE_POSITION:
            {
            ...
            case PVMF_G711_PARSER_NODE_SET_DATASOURCE_RATE:
            {
            ...
            case PVMF_G711_PARSER_NODE_GET_LICENSE_W:
            {
            ...
            case PVMF_G711_PARSER_NODE_GET_LICENSE:
            {
            ...
            case PVMF_G711_PARSER_NODE_CMD_CANCEL_GET_LICENSE:
...
void PVMFG711FFParserNode::SetState(TPVMFNodeInterfaceState s)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:SetState"));
    PVMFNodeInterface::SetState(s);
}

void PVMFG711FFParserNode::ReportErrorEvent(PVMFEventType aEventType, OsclAny* aEventData, PVUuid* aEventUUID, int32* aEventCode)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:ReportErrorEvent Type %d Data %d"
                    , aEventType, aEventData));

    if (aEventUUID && aEventCode)
    {
        PVMFBasicErrorInfoMessage* eventmsg;
        PVMF_G711_PARSER_NODE_NEW(NULL,
...
void PVMFG711FFParserNode::ReportInfoEvent(PVMFEventType aEventType, OsclAny* aEventData, PVUuid* aEventUUID, int32* aEventCode)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:ReportInfoEvent Type %d Data %d"
                    , aEventType, aEventData));
...
void PVMFG711FFParserNode::DoQueryUuid(PVMFG711FFNodeCommand& aCmd)
{
    OSCL_String* mimetype;
    Oscl_Vector<PVUuid, OsclMemAllocator> *uuidvec;
    bool exactmatch;
    aCmd.PVMFG711FFNodeCommandBase::Parse(mimetype, uuidvec, exactmatch);
...
void PVMFG711FFParserNode::DoQueryInterface(PVMFG711FFNodeCommand&  aCmd)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                    (0, "PVMFG711FFParserNode::DoQueryInterface"));

    PVUuid* uuid;
    PVInterface** ptr;
    aCmd.PVMFG711FFNodeCommandBase::Parse(uuid, ptr);
...
PVMFStatus PVMFG711FFParserNode::DoInit(PVMFG711FFNodeCommand& aCmd)
{
    OSCL_UNUSED_ARG(aCmd);
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::DoInitNode() In"));
    ...
    {
        if (CheckForG711HeaderAvailability() == PVMFSuccess)
        {
            ParseG711File();
...
PVMFStatus PVMFG711FFParserNode::ParseG711File()
{
    iG711Parser = OSCL_NEW(CG711FileParser, ());
    if (!iG711Parser)
    {
    ...
    if (iG711Parser->InitG711File(iSourceURL, true, &iFileServer, dsFactory, iFileHandle, iCountToClaculateRDATimeInterval))
    {
        iAvailableMetadataKeys.clear();
        if (iG711Parser->RetrieveFileInfo(iG711FileInfo))
        {
            ...
            else
            {
                ...
                PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::ParseG711File() - InitMetaData Failed"));
...
void PVMFG711FFParserNode::DoPrepare(PVMFG711FFNodeCommand& aCmd)
{
...
void PVMFG711FFParserNode::DoStart(PVMFG711FFNodeCommand& aCmd)
{
...
void PVMFG711FFParserNode::DoStop(PVMFG711FFNodeCommand& aCmd)
{
    iStreamID = 0;
    ...
    ResetAllTracks();
            ...
            // Reset the G711 FF to beginning
            if (iG711Parser)
            {
                iG711Parser->ResetPlayback(0);
            }
...
void PVMFG711FFParserNode::DoPause(PVMFG711FFNodeCommand& aCmd)
{
    if (iInterfaceState != EPVMFNodeStarted)
    {
        CommandComplete(iInputCommands, aCmd, PVMFErrInvalidState);
...
void PVMFG711FFParserNode::DoFlush(PVMFG711FFNodeCommand& aCmd)
{
...
bool PVMFG711FFParserNode::FlushPending()
{
    return (iCurrentCommand.size() > 0
            && iCurrentCommand.front().iCmd == PVMF_G711_PARSER_NODE_FLUSH);
}

void PVMFG711FFParserNode::DoReset(PVMFG711FFNodeCommand& aCmd)
{

    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::DoReset() Called"));
...
void
PVMFG711FFParserNode::MoveCmdToCurrentQueue(PVMFG711FFNodeCommand& aCmd)
{
    int32 err;
...
void
PVMFG711FFParserNode::MoveCmdToCancelQueue(PVMFG711FFNodeCommand& aCmd)
{
    /*
...
void PVMFG711FFParserNode::DoCancelAllCommands(PVMFG711FFNodeCommand& aCmd)
{
    while (!iCurrentCommand.empty())
    {
        MoveCmdToCancelQueue(aCmd);
...
void PVMFG711FFParserNode::DoCancelCommand(PVMFG711FFNodeCommand& aCmd)
{
    PVMFCommandId id;
    aCmd.PVMFG711FFNodeCommandBase::Parse(id);
    {
        PVMFG711FFNodeCommand* cmd = iCurrentCommand.FindById(id);
        if (cmd)
        {
    ...
    {
        PVMFG711FFNodeCommand* cmd = iInputCommands.FindById(id, 1);
        if (cmd)
        {
            //cancel the queued command
...
void PVMFG711FFParserNode::DoRequestPort(PVMFG711FFNodeCommand& aCmd, PVMFPortInterface*&aPort)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::DoRequestPort() In"));
    aPort = NULL;

    if ((iInterfaceState != EPVMFNodePrepared) || (!iG711Parser))
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFASFParserNode::DoRequestPort() - Invalid State"));
        CommandComplete(iInputCommands, aCmd, PVMFErrInvalidState);
        return;
    }
    ...
    aCmd.PVMFG711FFNodeCommandBase::Parse(tag, mime_string);

    if (tag != PVMF_G711FFPARSER_NODE_PORT_TYPE_SOURCE)
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                        (0, "PVMFG711FFParserNode::DoRequestPort: Error - Invalid port tag"));
        CommandComplete(iInputCommands, aCmd, PVMFFailure);
        return;
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                        (0, "PVMFG711FFParserNode::DoRequestPort: Error - port already exists"));
        CommandComplete(iInputCommands, aCmd, PVMFFailure);
        return;
    }

    if ((int32)aCmd.iParam1 == PVMF_G711FFPARSER_NODE_PORT_TYPE_SOURCE)
    {

        iOutPort = OSCL_NEW(PVMFG711FFParserOutPort, (PVMF_G711FFPARSER_NODE_PORT_TYPE_SOURCE, this));
        if (!iOutPort)
        {
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                            (0, "PVMFG711FFParserNode::DoRequestPort: Error - no memory"));
            CommandComplete(iInputCommands, aCmd, PVMFErrNoMemory);
            return;
        }
        if (mime_string)
        {
            ...
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                                (0, "PVMFG711FFParserNode::DoRequestPort: Error - format not supported"));
        ...
        int32 leavecode = 0;
        OSCL_TRY(leavecode,
                 clockconv = OSCL_NEW(MediaClockConverter, (iG711FileInfo.iTimescale));
                 trackdatamempool = OSCL_NEW(OsclMemPoolFixedChunkAllocator, (PVG711FF_MEDIADATA_POOLNUM));
                 mediadataimplalloc = OSCL_NEW(PVMFSimpleMediaBufferCombinedAlloc, (trackdatamempool));
                 mediadatamempool = OSCL_NEW(PVMFMemPoolFixedChunkAllocator, ("G711FFPar", PVG711FF_MEDIADATA_POOLNUM, PVG711FF_MEDIADATA_CHUNKSIZE));
                );

        if (leavecode || !clockconv || !trackdatamempool || !mediadataimplalloc || !mediadatamempool)
        {
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                            (0, "PVMFG711FFParserNode::DoRequestPort: Error - unable to create clockconv, trackdatamempool, mediadataimplalloc, and mediadatamempool"));
            if (iOutPort)
            {
                OSCL_DELETE(iOutPort);
                iOutPort = NULL;
        ...
        PVG711FFNodeTrackPortInfo trackportinfo;

        trackportinfo.iTrackId = 0;  // Only support 1 channel so far
        trackportinfo.iTag = PVMF_G711FFPARSER_NODE_PORT_TYPE_SOURCE;
        ...
        trackportinfo.iResizableDataMemoryPoolSize = PVMF_G711_PARSER_NODE_MAX_AUDIO_DATA_MEM_POOL_SIZE;
        PVMF_G711_PARSER_NODE_NEW(NULL,
                                 OsclMemPoolResizableAllocator,
                                 (trackportinfo.iResizableDataMemoryPoolSize,
                                  PVMF_G711_PARSER_NODE_DATA_MEM_POOL_GROWTH_LIMIT),
                                 trackDataResizableMemPool);

        PVUuid eventuuid = PVMFG711ParserNodeEventTypesUUID;
        int32	errcode = PVMFG711FFParserErrTrackMediaMsgAllocatorCreationFailed;
        ...
        {
            PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::DoRequestPort() - trackDataResizableMemPool Alloc Failed"));
        ...
        uint8* typeSpecificInfoBuff = iG711Parser->getCodecSpecificInfo();
        uint32 typeSpecificDataLength = G711_MAX_NUM_PACKED_INPUT_BYTES;
        if ((int32)typeSpecificDataLength > 0)
        {
            ...
            {
                PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::PopulateTrackInfoVec - Unable to Allocate Memory"));
            }
    ...
    else
    {
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                        (0, "PVMFG711FFParserNode::DoRequestPort: Error - type not supported"));
        CommandComplete(iInputCommands, aCmd, PVMFFailure);
        return;
    }
...
void PVMFG711FFParserNode::DoReleasePort(PVMFG711FFNodeCommand& aCmd)
{

    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                    (0, "PVMFG711FFParserNode::DoReleasePort"));
    ...
    for (uint32 i = 0;i < iSelectedTrackList.size();i++)
    {
        if (iSelectedTrackList[i].iPort == aCmd.iParam1)
        {
            ...
            OSCL_DELETE(((PVMFG711FFParserOutPort*)iSelectedTrackList[i].iPort));
            ...
            {
                PVMF_G711_PARSER_NODE_DELETE(NULL,
                                            PVMFResizableSimpleMediaMsgAlloc,
...
void PVMFG711FFParserNode::ResetAllTracks()
{
    for (uint32 i = 0; i < iSelectedTrackList.size(); ++i)
    {
        iSelectedTrackList[i].iMediaData.Unbind();
...
void PVMFG711FFParserNode::CleanupFileSource()
{
    iAvailableMetadataKeys.clear();
...
void PVMFG711FFParserNode::CommandComplete(PVMFG711FFNodeCmdQ& aCmdQ, PVMFG711FFNodeCommand& aCmd, PVMFStatus aStatus, PVInterface*aExtMsg, OsclAny* aEventData)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG, iLogger, PVLOGMSG_INFO, (0, "PVMFG711FFParserNode:CommandComplete Id %d Cmd %d Status %d Context %d Data %d"
...
void PVMFG711FFParserNode::CommandComplete(PVMFG711FFNodeCmdQ& aCmdQ,
        ...
        PVInterface* aExtMsg)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::CommandComplete() In Id %d Cmd %d Status %d Context %d Data %d",
                                      aCmd.iId, aCmd.iCmd, aStatus, aCmd.iContext, aEventData));
...
PVMFCommandId PVMFG711FFParserNode::QueueCommandL(PVMFG711FFNodeCommand& aCmd)
{
    if (IsAdded())
    {
        PVMFCommandId id;
...
void PVMFG711FFParserNode::addRef()
{
    ++iExtensionRefCount;
}

void PVMFG711FFParserNode::removeRef()
{
    --iExtensionRefCount;
}

PVMFStatus PVMFG711FFParserNode::QueryInterfaceSync(PVMFSessionId aSession,
        const PVUuid& aUuid,
        PVInterface*& aInterfacePtr)
{
...
bool PVMFG711FFParserNode::queryInterface(const PVUuid& uuid, PVInterface*& iface)
{
...
PVMFStatus PVMFG711FFParserNode::SetSourceInitializationData(OSCL_wString& aSourceURL, PVMFFormatType& aSourceFormat, OsclAny* aSourceData)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::SetSourceInitializationData() called"));
    if (aSourceFormat == PVMF_MIME_G711FF)
    {
    ...
    PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::SetSourceInitializationData - Unsupported Format"));
    return PVMFFailure;
}

PVMFStatus PVMFG711FFParserNode::SetClientPlayBackClock(PVMFMediaClock* aClientClock)
{
    OSCL_UNUSED_ARG(aClientClock);
    return PVMFSuccess;
}

PVMFStatus PVMFG711FFParserNode::SetEstimatedServerClock(PVMFMediaClock* aClientClock)
{
    OSCL_UNUSED_ARG(aClientClock);
    return PVMFSuccess;
}

PVMFStatus PVMFG711FFParserNode::GetMediaPresentationInfo(PVMFMediaPresentationInfo& aInfo)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::GetMediaPresentationInfo() called"));
    ...
    aInfo.setDurationValue(iG711FileInfo.iDuration);
    // Current version of AAC parser is limited to 1 channel
    PVMFTrackInfo tmpTrackInfo;
    tmpTrackInfo.setPortTag(PVMF_G711FFPARSER_NODE_PORT_TYPE_SOURCE);
    tmpTrackInfo.setTrackID(0);
    TPVG711FileInfo g711info;
    if (!iG711Parser->RetrieveFileInfo(g711info)) return PVMFErrNotSupported;

    tmpTrackInfo.setTrackBitRate(g711info.iBitrate);
    tmpTrackInfo.setTrackDurationTimeScale((uint64)g711info.iTimescale);
    tmpTrackInfo.setTrackDurationValue(g711info.iDuration);
    OSCL_FastString mime_type = _STRLIT_CHAR(PVMF_MIME_G711);
...
PVMFStatus PVMFG711FFParserNode::SelectTracks(PVMFMediaPresentationInfo& aInfo)
{
    OSCL_UNUSED_ARG(aInfo);
    return PVMFSuccess;
}

uint32 PVMFG711FFParserNode::GetNumMetadataKeys(char* aQueryKeyString)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::GetNumMetadataKeys() called"));
...
uint32 PVMFG711FFParserNode::GetNumMetadataValues(PVMFMetadataList& aKeyList)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::GetNumMetadataValues() called"));

    uint32 numkeys = aKeyList.size();
    if (!iG711Parser || numkeys == 0)
    {
        return 0;
    }
    ...
    for (uint32 lcv = 0; lcv < numkeys; lcv++)
    {
        if (oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_DURATION_KEY) == 0 &&
                iG711FileInfo.iDuration > 0)
        {
            // Movie Duration
            ++numvalentries;
        }
        else if (oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_NUMTRACKS_KEY) == 0)
        {
            // Number of tracks
            ++numvalentries;
        }
        else if ((oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_TRACKINFO_BITRATE_KEY) == 0) &&
                 iG711FileInfo.iBitrate > 0)
        {
            // Bitrate
            ++numvalentries;
        }
        else if (oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_TRACKINFO_AUDIO_FORMAT_KEY))
        {
            // Format
            ++numvalentries;
        }
        else if (oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_RANDOM_ACCESS_DENIED_KEY) == 0)
        {
            /*
             * Random Access
             * Increment the counter for the number of values found so far
        ...
        else if (oscl_strcmp(aKeyList[lcv].get_cstr(), PVG711METADATA_CLIP_TYPE_KEY) == 0)
        {
            /*
             * clip-type
             * Increment the counter for the number of values found so far
...
PVMFCommandId PVMFG711FFParserNode::GetNodeMetadataKeys(PVMFSessionId aSessionId, PVMFMetadataList& aKeyList
        , uint32 aStartingKeyIndex, int32 aMaxKeyEntries, char* aQueryKeyString, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::GetNodeMetadataKeys() called"));

    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_GETNODEMETADATAKEYS, aKeyList, aStartingKeyIndex, aMaxKeyEntries, aQueryKeyString, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::GetNodeMetadataValues(PVMFSessionId aSessionId, PVMFMetadataList& aKeyList, Oscl_Vector<PvmiKvp, OsclMemAllocator>& aValueList
        , uint32 aStartingValueIndex, int32 aMaxValueEntries, const OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::GetNodeMetadataValue() called"));

    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_GETNODEMETADATAVALUES, aKeyList, aValueList, aStartingValueIndex, aMaxValueEntries, aContext);
    return QueueCommandL(cmd);
}

PVMFStatus PVMFG711FFParserNode::ReleaseNodeMetadataKeys(PVMFMetadataList& , uint32 , uint32)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::ReleaseNodeMetadataKeys() called"));
    return PVMFSuccess;
}

PVMFStatus PVMFG711FFParserNode::ReleaseNodeMetadataValues(Oscl_Vector<PvmiKvp, OsclMemAllocator>& aValueList, uint32 start, uint32 end)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::ReleaseNodeMetadataValues() called"));

    if (start > end || aValueList.size() == 0)
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_ERR, (0, "PVMFG711FFParserNode::ReleaseNodeMetadataValues() Invalid start/end index"));
        return PVMFErrArgument;
    }

    end = OSCL_MIN(aValueList.size(), iG711ParserNodeMetadataValueCount);
...
PVMFCommandId PVMFG711FFParserNode::SetDataSourcePosition(PVMFSessionId aSessionId
...
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                    (0, "PVMFG711FFParserNode::SetDataSourcePosition: aTargetNPT=%d, aSeekToSyncPoint=%d, aContext=0x%x",
                     aTargetNPT, aSeekToSyncPoint, aContext));

    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_SET_DATASOURCE_POSITION, aTargetNPT, aActualNPT,
                                        aActualMediaDataTS, aSeekToSyncPoint, aStreamID, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::QueryDataSourcePosition(PVMFSessionId aSessionId
        , PVMFTimestamp aTargetNPT
        , PVMFTimestamp& aActualNPT
        , bool aSeekToSyncPoint
        , OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                    (0, "PVMFG711FFParserNode::QueryDataSourcePosition: aTargetNPT=%d, aSeekToSyncPoint=%d, aContext=0x%x",
                     aTargetNPT, aSeekToSyncPoint, aContext));

    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_QUERY_DATASOURCE_POSITION, aTargetNPT, aActualNPT,
        ...
        , bool aSeekToSyncPoint)
{
    ...
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_QUERY_DATASOURCE_POSITION, aTargetNPT, aSeekPointBeforeTargetNPT,
                                        aSeekToSyncPoint, aContext);
    return QueueCommandL(cmd);
}

PVMFCommandId PVMFG711FFParserNode::SetDataSourceRate(PVMFSessionId aSessionId
        , int32 aRate
        , PVMFTimebase* aTimebase
        , OsclAny* aContext)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::SetDataSourceRate() called"));

    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId, PVMF_G711_PARSER_NODE_SET_DATASOURCE_RATE, aRate, aTimebase, aContext);
    return QueueCommandL(cmd);
}


PVMFStatus PVMFG711FFParserNode::CheckForG711HeaderAvailability()
{
    if (iDataStreamInterface != NULL)
    {
        /*
        ...
        if (currCapacity <  G711_MIN_DATA_SIZE_FOR_RECOGNITION)
        {
            iRequestReadCapacityNotificationID =
                iDataStreamInterface->RequestReadCapacityNotification(iDataStreamSessionID,
                        *this,
                        G711_MIN_DATA_SIZE_FOR_RECOGNITION);
            return PVMFPending;
        }


        uint32 headerSize32 =
            Oscl_Int64_Utils::get_uint64_lower32(iG711HeaderSize);
...
bool PVMFG711FFParserNode::GetTrackInfo(PVMFPortInterface* aPort,
...
bool PVMFG711FFParserNode::GetTrackInfo(int32 aTrackID,
                                       PVG711FFNodeTrackPortInfo*& aTrackInfoPtr)
{
    Oscl_Vector<PVG711FFNodeTrackPortInfo, PVMFG711ParserNodeAllocator>::iterator it;
    for (it = iSelectedTrackList.begin(); it != iSelectedTrackList.end(); it++)
...
bool PVMFG711FFParserNode::ProcessPortActivity(PVG711FFNodeTrackPortInfo* aTrackInfoPtr)
{
    /*
     * called by the AO to process a port activity message
     */
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::ProcessPortActivity() Called"));
    ...
    if (aTrackInfoPtr->oQueueOutgoingMessages)
    {
        ...
        {
            PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::ProcessPortActivity() QueueMediaSample Failed - Err=%d", status));
            return false;
        }
        if (iAutoPaused == true)
        {
            aTrackInfoPtr->oQueueOutgoingMessages = false;
            PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::QueueMediaSample() - Auto Paused"));
            return PVMFErrBusy;
        }
        if (aTrackInfoPtr->iPort->IsOutgoingQueueBusy())
        {
            aTrackInfoPtr->oQueueOutgoingMessages = false;
            PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::QueueMediaSample() Port Outgoing Queue Busy"));
            return PVMFErrBusy;
        }
    ...
    if (aTrackInfoPtr->oProcessOutgoingMessages)
    {
        if (aTrackInfoPtr->iPort->OutgoingMsgQueueSize() > 0)
        {
            ...
            if ((status != PVMFErrBusy) &&
                    ...
                    (status != PVMFErrInvalidState))
            {
                PVMF_G711PARSERNODE_LOGERROR((0, "PVMFASFParserNode::ProcessPortActivity() ProcessOutgoingMsg Failed - Err=%d", status));
...
bool PVMFG711FFParserNode::CheckForPortRescheduling()
{
    PVG711FFNodeTrackPortInfo* trackInfoPtr = NULL;
    if (!GetTrackInfo(iOutPort, trackInfoPtr))
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::CheckForPortRescheduling: Error - GetPortContainer failed"));
        return false;
    }
...
PVMFStatus PVMFG711FFParserNode::InitMetaData()
{
    if (iG711FileInfo.iFileSize > 0)
    {
        // Populate the metadata key vector based on info available
        PushToAvailableMetadataKeysList(PVG711METADATA_NUMTRACKS_KEY);
        if (iG711FileInfo.iDuration > 0)
        {
            PushToAvailableMetadataKeysList(PVG711METADATA_DURATION_KEY);

        }
        if (iG711FileInfo.iBitrate > 0)
        {
            PushToAvailableMetadataKeysList(PVG711METADATA_TRACKINFO_BITRATE_KEY);

        }
        PushToAvailableMetadataKeysList(PVG711METADATA_TRACKINFO_AUDIO_FORMAT_KEY);
        PushToAvailableMetadataKeysList(PVG711METADATA_RANDOM_ACCESS_DENIED_KEY);
        PushToAvailableMetadataKeysList(PVG711METADATA_CLIP_TYPE_KEY);

        //set clip duration on download progress interface
        //applicable to PDL sessions
        {
            if ((iDownloadProgressInterface != NULL) && (iG711FileInfo.iDuration != 0))
            {
                iDownloadProgressInterface->setClipDuration(OSCL_CONST_CAST(uint32, iG711FileInfo.iDuration));
            }
        }
...
void PVMFG711FFParserNode::PushToAvailableMetadataKeysList(const char* aKeystr, char* aOptionalParam)
{
    if (aKeystr == NULL)
    {
        return;
...
void PVMFG711FFParserNode::InitCPM()
{
    iCPMInitCmdId = iCPM->Init();
}

void PVMFG711FFParserNode::OpenCPMSession()
{
    iCPMOpenSessionCmdId = iCPM->OpenSession(iCPMSessionID);
}

void PVMFG711FFParserNode::CPMRegisterContent()
{
...
void PVMFG711FFParserNode::GetCPMLicenseInterface()
{
...
bool PVMFG711FFParserNode::GetCPMContentAccessFactory()
{
...
bool PVMFG711FFParserNode::GetCPMMetaDataExtensionInterface()
{
...
void PVMFG711FFParserNode::RequestUsage()
{
    PopulateDRMInfo();
...
void PVMFG711FFParserNode::PopulateDRMInfo()
{
    if (iRequestedUsage.key)
    {
        OSCL_ARRAY_DELETE(iRequestedUsage.key);
...
void PVMFG711FFParserNode::SendUsageComplete()
{
    iCPMUsageCompleteCmdId = iCPM->UsageComplete(iCPMSessionID, iUsageID);
}

void PVMFG711FFParserNode::CloseCPMSession()
{
    iCPMCloseSessionCmdId = iCPM->CloseSession(iCPMSessionID);
}

void PVMFG711FFParserNode::ResetCPM()
{
    iCPMResetCmdId = iCPM->Reset();
}

void PVMFG711FFParserNode::GetCPMMetaDataKeys()
{
    if (iCPMMetaDataExtensionInterface != NULL)
    {
        ...
        iCPMGetMetaDataKeysCmdId =
            iCPMMetaDataExtensionInterface->GetNodeMetadataKeys(iCPMSessionID,
                    iCPMMetadataKeys,
                    0,
                    PVMF_G711_PARSER_NODE_MAX_CPM_METADATA_KEYS);
    }
}

void PVMFG711FFParserNode::CPMCommandCompleted(const PVMFCmdResp& aResponse)
{
    ...
    if (id == iCPMCancelGetLicenseCmdId)
    {
         ...
         */
        PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711FFParserNode::CPMCommandCompleted -  CPM CancelGetLicense complete"));
    ...
    else if (id == iCPMRegisterContentCmdId && status == PVMFErrNotSupported)
    {
        ...
        PVMF_G711PARSERNODE_LOGINFO((0, "PVMFG711ParserNode::CPMCommandCompleted - Unknown CPM Format - Ignoring CPM"));
        if (CheckForG711HeaderAvailability() == PVMFSuccess)
        {
            if (ParseG711File())
            {
                ...
                OSCL_ASSERT(iCurrentCommand.front().iCmd == PVMF_G711_PARSER_NODE_INIT);
                CompleteInit();
            }
        }
        return;
    ...
    else
    {
        ...
        else if (id == iCPMResetCmdId)
        {
            ...
            OSCL_ASSERT(!iCurrentCommand.empty());
            OSCL_ASSERT(iCurrentCommand.front().iCmd == PVMF_G711_PARSER_NODE_RESET);
            CompleteReset();
        }
        else if (id == iCPMGetMetaDataValuesCmdId)
        {
            ...
            OSCL_ASSERT(!iCurrentCommand.empty());
            OSCL_ASSERT(iCurrentCommand.front().iCmd == PVMF_G711_PARSER_NODE_GETNODEMETADATAVALUES);
    ...
    if (!iCancelCommand.empty())
    {
        if (iCancelCommand.front().iCmd != PVMF_G711_PARSER_NODE_CMD_CANCEL_GET_LICENSE)
        {
            CommandComplete(iCancelCommand,
                            iCancelCommand.front(),
                            PVMFSuccess);
...
void PVMFG711FFParserNode::PassDatastreamFactory(PVMFDataStreamFactory& aFactory,
        int32 aFactoryTag,
...
void
PVMFG711FFParserNode::PassDatastreamReadCapacityObserver(PVMFDataStreamReadCapacityObserver* aObserver)
{
    iDataStreamReadCapacityObserver = aObserver;
}

void PVMFG711FFParserNode::CompleteInit()
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::CompleteInit() Called"));
    if (iCPM)
    {
...
void PVMFG711FFParserNode::CompleteGetMetaDataValues()
{
    CommandComplete(iCurrentCommand,
                    iCurrentCommand.front(),
                    PVMFSuccess);
...
void PVMFG711FFParserNode::setFileSize(const uint32 aFileSize)
{
    iDownloadFileSize = aFileSize;
}

int32 PVMFG711FFParserNode::convertSizeToTime(uint32 aFileSize, uint32& aNPTInMS)
{
...
void PVMFG711FFParserNode::setDownloadProgressInterface(PVMFDownloadProgressInterface* aInterface)
{
    if (aInterface == NULL)
    {
        OSCL_ASSERT(false);
...
void PVMFG711FFParserNode::DataStreamInformationalEvent(const PVMFAsyncEvent& aEvent)
{
    OSCL_UNUSED_ARG(aEvent);
    OSCL_LEAVE(OsclErrNotSupported);
}

void PVMFG711FFParserNode::DataStreamErrorEvent(const PVMFAsyncEvent& aEvent)
{
    OSCL_UNUSED_ARG(aEvent);
    OSCL_LEAVE(OsclErrNotSupported);
}

void PVMFG711FFParserNode::DataStreamCommandCompleted(const PVMFCmdResp& aResponse)
{
    if (aResponse.GetCmdId() == iRequestReadCapacityNotificationID)
    {
        ...
        {
            PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::DataStreamCommandCompleted() Failed %d", cmdStatus));
            CommandComplete(iCurrentCommand,
                            iCurrentCommand.front(),
                            PVMFErrResource);
...
void PVMFG711FFParserNode::playResumeNotification(bool aDownloadComplete)
{
    iAutoPaused = false;
    ...
    if (!GetTrackInfo(iOutPort, trackInfoPtr))
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFASFParserNode::playResumeNotification: Error - GetPortContainer failed"));
        return;
    }
    ...
    PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::playResumeNotification() - Auto Resume Triggered - FileSize = %d, NPT = %d", iFileSizeLastConvertedToTime, iLastNPTCalcInConvertSizeToTime));
    PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::playResumeNotification() - Auto Resume Triggered - FileSize = %d, NPT = %d", iFileSizeLastConvertedToTime, iLastNPTCalcInConvertSizeToTime));
    RunIfNotReady();
}

void PVMFG711FFParserNode::CompleteReset()
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::CompleteReset() Called"));
    /* stop and cleanup */
    ReleaseAllPorts();
    CleanupFileSource();
    SetState(EPVMFNodeIdle);
...
PVMFStatus PVMFG711FFParserNode::ThreadLogoff()
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::ThreadLogoff() Called"));
    if (iInterfaceState == EPVMFNodeIdle)
    {
        CleanupFileSource();
        iFileServer.Close();
    ...
    PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::ThreadLogoff() - Invalid State"));
    return PVMFErrInvalidState;
}

PVMFStatus PVMFG711FFParserNode::QueueMediaSample(PVG711FFNodeTrackPortInfo* aTrackInfoPtr)
{
    if (iAutoPaused == true)
    {
        aTrackInfoPtr->oQueueOutgoingMessages = false;
    ...
    if (aTrackInfoPtr->oQueueOutgoingMessages)
    {
        ...
        if (aTrackInfoPtr->oEOSReached == false)
        {
            ...
            if (status == PVMFErrBusy)
            {
                PVMF_G711PARSERNODE_LOGINFO((0, "PVMFG711ParserNode::QueueMediaSample() RetrieveMediaSample - Mem Pools Busy"));
                aTrackInfoPtr->oQueueOutgoingMessages = false;
                if (iAutoPaused == true)
                {
            ...
            else if (status == PVMFSuccess)
            {
                if (aTrackInfoPtr->oEOSReached == false)
                {
                    ...
                    if (status != PVMFSuccess)
                    {
                        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::QueueMediaSample: Error - QueueOutgoingMsg failed"));
                        ReportErrorEvent(PVMFErrPortProcessing);
                    }
            ...
            {
                PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::QueueMediaSample() - Sample Retrieval Failed"));
...
PVMFStatus PVMFG711FFParserNode::RetrieveMediaSample(PVG711FFNodeTrackPortInfo* aTrackInfoPtr,
        PVMFSharedMediaDataPtr& aMediaDataOut)
{
    ...
    uint32 numsamples = NUM_G711_FRAMES;
    ...
    int32 retval = iG711Parser->GetNextBundledAccessUnits(&numsamples, &gau);
    ...
    if (retval == g711bitstreamObject::EVERYTHING_OK)
    {
        ...
        aTrackInfoPtr->iContinuousTimeStamp += numsamples * G711_SAMPLE_DURATION; // i.e 20ms
    ...
    else if (retval == g711bitstreamObject::DATA_INSUFFICIENT)
    {
        ...
        if (iDownloadProgressInterface != NULL)
        {
            ...
            iDownloadProgressInterface->requestResumeNotification(aTrackInfoPtr->iContinuousTimeStamp,
                    iDownloadComplete);
            iAutoPaused = true;
            PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::RetrieveMediaSample() - Auto Pause Triggered - TS=%d", aTrackInfoPtr->iContinuousTimeStamp));
            PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::RetrieveMediaSample() - Auto Pause Triggered - TS=%d", aTrackInfoPtr->iContinuousTimeStamp));
            return PVMFErrBusy;
        }
        else
        {
    ...
    else if (retval == g711bitstreamObject::END_OF_FILE)
    {
        aTrackInfoPtr->oEOSReached = true;
    }
    else
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::RetrieveMediaSample() - Sample Retrieval Failed"));
        return PVMFFailure;
    }
...
void PVMFG711FFParserNode::PauseAllMediaRetrieval()
{
    PVG711FFNodeTrackPortInfo* trackInfoPtr = NULL;
    if (!GetTrackInfo(iOutPort, trackInfoPtr))
    {
        PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::PauseAllMediaRetrieval: Error - GetPortContainer failed"));
        return;
    }
...
PVMFStatus PVMFG711FFParserNode:: GenerateAndSendEOSCommand(PVG711FFNodeTrackPortInfo* aTrackInfoPtr)
{
    PVMF_G711PARSERNODE_LOGSTACKTRACE((0, "PVMFG711ParserNode::GenerateAndSendEOSCommand Called"));
    if (aTrackInfoPtr->iPort->IsOutgoingQueueBusy() == true)
    {
        /* come back later */
        PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711ParserNode::GenerateAndSendEOSCommand: Waiting - Output Queue Busy"));
        return PVMFErrBusy;
    }
    ...
    if ((aTrackInfoPtr->oEOSSent == false) && (aTrackInfoPtr->oEOSReached == true))
    {
        ...
        if (status != PVMFSuccess)
        {
            ...
            PVMF_G711PARSERNODE_LOGERROR((0, "PVMFG711ParserNode::GenerateAndSendEOSCommand: Error Sending EOS"));
            return status;
        }
...
bool PVMFG711FFParserNode::RetrieveTrackData(PVG711FFNodeTrackPortInfo& aTrackPortInfo)
{
    // Create a data buffer from pool
    int errcode = 0;
    OsclSharedPtr<PVMFMediaDataImpl> mediaDataImplOut;
    ...
    // Temporary retrieve 32 frames since G711 MDF needs 32 frames
    uint32 numsamples = NUM_G711_FRAMES;
    ...
    if (retval == g711bitstreamObject::EVERYTHING_OK)
    {
        ...
        aTrackPortInfo.iContinuousTimeStamp += numsamples * G711_SAMPLE_DURATION; // i.e 20ms
    ...
    else if (retval == g711bitstreamObject::READ_ERROR)
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::RetrieveTrackData() G711 Parser READ_ERROR"));
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::RetrieveTrackData() G711 Parser End Of File!"));
        if (SendEndOfTrackCommand(aTrackPortInfo))
        {
            // EOS message sent so change state
            PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "PVMFG711FFParserNode::RetrieveTrackData() Sending EOS message succeeded"));
            return false;
        }
        else
        {
            // EOS message could not be queued so keep in same state and try again later
            PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_NOTICE, (0, "PVMFG711FFParserNode::RetrieveTrackData() Sending EOS message failed"));
            return true;
        }
    }
    else
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::RetrieveTrackData() G711 Parser Unknown Error!"));
        PVUuid erruuid = PVMFFileFormatEventTypesUUID;
...
PVMFStatus PVMFG711FFParserNode::SendBeginOfMediaStreamCommand(PVG711FFNodeTrackPortInfo* aTrackPortInfoPtr)
{
    PVMFSharedMediaCmdPtr sharedMediaCmdPtr = PVMFMediaCmd::createMediaCmd();
    ...
    if (status != PVMFSuccess)
    {
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "PVMFG711FFParserNode::SendBeginOfMediaStreamCommand: Outgoing queue busy. "));
        return status;
    }
    aTrackPortInfoPtr->iSendBOS = false;
    aTrackPortInfoPtr->oProcessOutgoingMessages = true;
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "PVMFG711FFParserNode::SendBeginOfMediaStreamCommand() BOS Sent StreamId %d ", iStreamID));
    return status;
}

PVMFCommandId
PVMFG711FFParserNode::GetLicense(PVMFSessionId aSessionId,
...
{
    PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711FFParserNode::GetLicense - Wide called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommand::Construct(aSessionId,
...
PVMFStatus PVMFG711FFParserNode::DoGetLicense(PVMFG711FFNodeCommand& aCmd,
        bool aWideCharVersion)
{
    ...
    if (aWideCharVersion == true)
    {
        ...
        uint32 dataSize = 0;
        int32 timeoutMsec = 0;
        aCmd.PVMFG711FFNodeCommand::Parse(contentName,
                                         data,
                                         dataSize,
                                         timeoutMsec);
        iCPMGetLicenseCmdId =
...
void PVMFG711FFParserNode::CompleteGetLicense()
{
    CommandComplete(iCurrentCommand,
                    iCurrentCommand.front(),
                    PVMFSuccess);
...
PVMFCommandId
PVMFG711FFParserNode::CancelGetLicense(PVMFSessionId aSessionId, PVMFCommandId aCmdId, OsclAny* aContextData)
{
    PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711FFParserNode::CancelGetLicense - called"));
    PVMFG711FFNodeCommand cmd;
    cmd.PVMFG711FFNodeCommandBase::Construct(aSessionId, PVMF_G711_PARSER_NODE_CMD_CANCEL_GET_LICENSE, aCmdId, aContextData);
    return QueueCommandL(cmd);
}

PVMFStatus PVMFG711FFParserNode::DoCancelGetLicense(PVMFG711FFNodeCommand& aCmd)
{
    PVMF_G711PARSERNODE_LOGDATATRAFFIC((0, "PVMFG711FFParserNode::DoCancelGetLicense() Called"));
    ...
    else
    {
        ...
        if (cmd)
        {
            if (cmd->iCmd == PVMF_G711_PARSER_NODE_GET_LICENSE_W || cmd->iCmd == PVMF_G711_PARSER_NODE_GET_LICENSE)
            {
...
int32 PVMFG711FFParserNode::PushBackKeyVal(Oscl_Vector<PvmiKvp, OsclMemAllocator>*& aValueListPtr, PvmiKvp &aKeyVal)
{
    int32 leavecode = 0;
...
PVMFStatus PVMFG711FFParserNode::PushValueToList(Oscl_Vector<OSCL_HeapString<OsclMemAllocator>, OsclMemAllocator> &aRefMetaDataKeys, PVMFMetadataList *&aKeyListPtr, uint32 aLcv)
{
    int32 leavecode = 0;
    OSCL_TRY(leavecode, aKeyListPtr->push_back(aRefMetaDataKeys[aLcv]));
    OSCL_FIRST_CATCH_ANY(leavecode, PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG, iLogger, PVLOGMSG_ERR, (0, "PVMFG711FFParserNode::PushValueToList() Memory allocation failure when copying metadata key"));return PVMFErrNoMemory);
    return PVMFSuccess;
}
