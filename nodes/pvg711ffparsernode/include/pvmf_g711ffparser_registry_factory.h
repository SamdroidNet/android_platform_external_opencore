 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_G711FFPARSER_REGISTRY_FACTORY_H_INCLUDED
#define PVMF_G711FFPARSER_REGISTRY_FACTORY_H_INCLUDED
...
class PVMFG711FFParserNodeRegistryFactory: public PVMFNodeCreationInterface
            , public PvmiCapabilityAndConfig
{
    public:
        ...
        */
        ...
        {
            info.iUuid = KPVMFG711FFParserNodeUuid;
            ...
            info.iCapability.AddInputFormat("multiplexed/x-g711-ff");
        }
        ...
        PVMFNodeInterface* CreateNode(OsclAny*aParam = NULL)
        {
            ...
            return PVMFG711FFParserNodeFactory::CreatePVMFG711FFParserNode();
        }
        void ReleaseNode(PVMFNodeInterface* aNode)
        {
            PVMFG711FFParserNodeFactory::DeletePVMFG711FFParserNode(aNode);
        }
...
#endif // PVMF_G711FFPARSER_REGISTRY_FACTORY_H_INCLUDED
