 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_AC3FFPARSER_REGISTRY_FACTORY_H_INCLUDED
#define PVMF_AC3FFPARSER_REGISTRY_FACTORY_H_INCLUDED
...
class PVMFAC3FFParserNodeRegistryFactory: public PVMFNodeCreationInterface
            , public PvmiCapabilityAndConfig
{
    public:
        ...
        */
        ...
        {
            info.iUuid = KPVMFAC3FFParserNodeUuid;
            ...
            info.iCapability.AddInputFormat("multiplexed/x-ac3-ff");
        }
        ...
        PVMFNodeInterface* CreateNode(OsclAny*aParam = NULL)
        {
            ...
            return PVMFAC3FFParserNodeFactory::CreatePVMFAC3FFParserNode();
        }
        void ReleaseNode(PVMFNodeInterface* aNode)
        {
            PVMFAC3FFParserNodeFactory::DeletePVMFAC3FFParserNode(aNode);
        }
...
#endif // PVMF_AC3FFPARSER_REGISTRY_FACTORY_H_INCLUDED
