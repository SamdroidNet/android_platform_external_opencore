 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_AC3FFPARSER_OUTPORT_H_INCLUDED
#define PVMF_AC3FFPARSER_OUTPORT_H_INCLUDED
...
typedef OsclMemAllocator PVMFAC3ParserNodeAllocator;

#define PVMF_AC3PARSERNODE_LOGERROR(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_ERR,m);
#define PVMF_AC3PARSERNODE_LOGWARNING(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_WARNING,m);
#define PVMF_AC3PARSERNODE_LOGINFOHI(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_AC3PARSERNODE_LOGINFOMED(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_AC3PARSERNODE_LOGINFOLOW(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_AC3PARSERNODE_LOGINFO(m) PVMF_AC3PARSERNODE_LOGINFOMED(m)
#define PVMF_AC3PARSERNODE_LOGSTACKTRACE(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_STACK_TRACE,m);
#define PVMF_AC3PARSERNODE_LOGDATATRAFFIC(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iDataPathLogger,PVLOGMSG_INFO,m);
#define PVMF_AC3PARSERNODE_LOGCLOCK(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iClockLogger,PVLOGMSG_INFO,m);
#define PVMF_AC3PARSERNODE_LOGBIN(iPortLogger, m) PVLOGGER_LOGBIN(PVLOGMSG_INST_LLDBG, iPortLogger, PVLOGMSG_ERR, m);


class PVMFAC3ParserNodeLoggerDestructDealloc : public OsclDestructDealloc
{
    public:
...
class PVAC3FFNodeTrackPortInfo : public OsclMemPoolFixedChunkAllocatorObserver,
            public OsclMemPoolResizableAllocatorObserver
{
    public:
        ...
        PVAC3FFNodeTrackPortInfo(const PVAC3FFNodeTrackPortInfo& aSrc) :
        ...
        virtual ~PVAC3FFNodeTrackPortInfo()
        {
        }
        ...
        void freechunkavailable(OsclAny* aContextData)
        {
            ...
            PVMF_AC3PARSERNODE_LOGINFO((0, "MimeType = %s, freeblockavailable", iTrackMimeType.get_cstr()));
            oQueueOutgoingMessages = true;
            if (iNode)
            {
        ...
        OSCL_HeapString<PVMFAC3ParserNodeAllocator> iTrackMimeType;
        ...
        OSCL_HeapString<PVMFAC3ParserNodeAllocator> iLogFile;
        bool oFormatSpecificInfoLogged;

        OsclSharedPtr<PVLoggerAppender> iBinAppenderPtr;
};

class PVMFAC3FFParserOutPort : public PvmfPortBaseImpl
            , public PvmiCapabilityAndConfig
{
    public:
         ...
         */
        PVMFAC3FFParserOutPort(int32 aTag
    ...
    private:
        ...
        PVMFAC3FFParserNode* iAC3ParserNode;
};

#endif // PVMF_AC3FFPARSER_OUTPORT_H_INCLUDED
