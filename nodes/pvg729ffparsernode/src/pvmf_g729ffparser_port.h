 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_G729FFPARSER_OUTPORT_H_INCLUDED
#define PVMF_G729FFPARSER_OUTPORT_H_INCLUDED
...
typedef OsclMemAllocator PVMFG729ParserNodeAllocator;

#define PVMF_G729PARSERNODE_LOGERROR(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_ERR,m);
#define PVMF_G729PARSERNODE_LOGWARNING(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_WARNING,m);
#define PVMF_G729PARSERNODE_LOGINFOHI(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G729PARSERNODE_LOGINFOMED(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G729PARSERNODE_LOGINFOLOW(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_G729PARSERNODE_LOGINFO(m) PVMF_G729PARSERNODE_LOGINFOMED(m)
#define PVMF_G729PARSERNODE_LOGSTACKTRACE(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_STACK_TRACE,m);
#define PVMF_G729PARSERNODE_LOGDATATRAFFIC(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iDataPathLogger,PVLOGMSG_INFO,m);
#define PVMF_G729PARSERNODE_LOGCLOCK(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iClockLogger,PVLOGMSG_INFO,m);
#define PVMF_G729PARSERNODE_LOGBIN(iPortLogger, m) PVLOGGER_LOGBIN(PVLOGMSG_INST_LLDBG, iPortLogger, PVLOGMSG_ERR, m);


class PVMFG729ParserNodeLoggerDestructDealloc : public OsclDestructDealloc
{
    public:
...
class PVG729FFNodeTrackPortInfo : public OsclMemPoolFixedChunkAllocatorObserver,
            public OsclMemPoolResizableAllocatorObserver
{
    public:

        PVG729FFNodeTrackPortInfo()
        {
            iTrackId = -1;
            iPort = NULL;
        ...
        PVG729FFNodeTrackPortInfo(const PVG729FFNodeTrackPortInfo& aSrc) :
        ...
        virtual ~PVG729FFNodeTrackPortInfo()
        {
        }
        ...
        void freechunkavailable(OsclAny* aContextData)
        {
            ...
            PVMF_G729PARSERNODE_LOGINFO((0, "MimeType = %s, freeblockavailable", iTrackMimeType.get_cstr()));
            oQueueOutgoingMessages = true;
            if (iNode)
            {
        ...
        OSCL_HeapString<PVMFG729ParserNodeAllocator> iTrackMimeType;
        ...
        OSCL_HeapString<PVMFG729ParserNodeAllocator> iLogFile;
        bool oFormatSpecificInfoLogged;

        OsclSharedPtr<PVLoggerAppender> iBinAppenderPtr;
};

class PVMFG729FFParserOutPort : public PvmfPortBaseImpl
            , public PvmiCapabilityAndConfig
{
    public:
         ...
         */
        PVMFG729FFParserOutPort(int32 aTag
    ...
    private:
        ...
        PVMFG729FFParserNode* iG729ParserNode;
};

#endif // PVMF_G729FFPARSER_OUTPORT_H_INCLUDED
