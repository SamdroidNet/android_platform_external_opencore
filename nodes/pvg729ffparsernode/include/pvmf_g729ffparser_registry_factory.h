 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_G729FFPARSER_REGISTRY_FACTORY_H_INCLUDED
#define PVMF_G729FFPARSER_REGISTRY_FACTORY_H_INCLUDED
...
class PVMFG729FFParserNodeRegistryFactory: public PVMFNodeCreationInterface
            , public PvmiCapabilityAndConfig
{
    public:
        ...
        */
        ...
        {
            info.iUuid = KPVMFG729FFParserNodeUuid;
            ...
            info.iCapability.AddInputFormat("multiplexed/x-g729-ff");
        }
        ...
        PVMFNodeInterface* CreateNode(OsclAny*aParam = NULL)
        {
            ...
            return PVMFG729FFParserNodeFactory::CreatePVMFG729FFParserNode();
        }
        void ReleaseNode(PVMFNodeInterface* aNode)
        {
            PVMFG729FFParserNodeFactory::DeletePVMFG729FFParserNode(aNode);
        }
...
#endif // PVMF_G729FFPARSER_REGISTRY_FACTORY_H_INCLUDED
