 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_EVRCFFPARSER_REGISTRY_FACTORY_H_INCLUDED
#define PVMF_EVRCFFPARSER_REGISTRY_FACTORY_H_INCLUDED
...
class PVMFEVRCFFParserNodeRegistryFactory: public PVMFNodeCreationInterface
            , public PvmiCapabilityAndConfig
{
    public:
        ...
        */
        ...
        {
            info.iUuid = KPVMFEVRCFFParserNodeUuid;
            ...
            info.iCapability.AddInputFormat("multiplexed/x-evrc-ff");
        }
        ...
        PVMFNodeInterface* CreateNode(OsclAny*aParam = NULL)
        {
            ...
            return PVMFEVRCFFParserNodeFactory::CreatePVMFEVRCFFParserNode();
        }
        void ReleaseNode(PVMFNodeInterface* aNode)
        {
            PVMFEVRCFFParserNodeFactory::DeletePVMFEVRCFFParserNode(aNode);
        }
...
#endif // PVMF_EVRCFFPARSER_REGISTRY_FACTORY_H_INCLUDED
