 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_EVRCFFPARSER_OUTPORT_H_INCLUDED
#define PVMF_EVRCFFPARSER_OUTPORT_H_INCLUDED
...
typedef OsclMemAllocator PVMFEVRCParserNodeAllocator;

#define PVMF_EVRCPARSERNODE_LOGERROR(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_ERR,m);
#define PVMF_EVRCPARSERNODE_LOGWARNING(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iLogger,PVLOGMSG_WARNING,m);
#define PVMF_EVRCPARSERNODE_LOGINFOHI(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_HLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_EVRCPARSERNODE_LOGINFOMED(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_MLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_EVRCPARSERNODE_LOGINFOLOW(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_INFO,m);
#define PVMF_EVRCPARSERNODE_LOGINFO(m) PVMF_EVRCPARSERNODE_LOGINFOMED(m)
#define PVMF_EVRCPARSERNODE_LOGSTACKTRACE(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG,iLogger,PVLOGMSG_STACK_TRACE,m);
#define PVMF_EVRCPARSERNODE_LOGDATATRAFFIC(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iDataPathLogger,PVLOGMSG_INFO,m);
#define PVMF_EVRCPARSERNODE_LOGCLOCK(m) PVLOGGER_LOGMSG(PVLOGMSG_INST_REL,iClockLogger,PVLOGMSG_INFO,m);
#define PVMF_EVRCPARSERNODE_LOGBIN(iPortLogger, m) PVLOGGER_LOGBIN(PVLOGMSG_INST_LLDBG, iPortLogger, PVLOGMSG_ERR, m);


class PVMFEVRCParserNodeLoggerDestructDealloc : public OsclDestructDealloc
{
    public:
...
class PVEVRCFFNodeTrackPortInfo : public OsclMemPoolFixedChunkAllocatorObserver,
            public OsclMemPoolResizableAllocatorObserver
{
    public:

        PVEVRCFFNodeTrackPortInfo()
        {
            iTrackId = -1;
            iPort = NULL;
        ...
        PVEVRCFFNodeTrackPortInfo(const PVEVRCFFNodeTrackPortInfo& aSrc) :
        ...
        virtual ~PVEVRCFFNodeTrackPortInfo()
        {
        }
        ...
        void freechunkavailable(OsclAny* aContextData)
        {
            ...
            PVMF_EVRCPARSERNODE_LOGINFO((0, "MimeType = %s, freeblockavailable", iTrackMimeType.get_cstr()));
            oQueueOutgoingMessages = true;
            if (iNode)
            {
        ...
        OSCL_HeapString<PVMFEVRCParserNodeAllocator> iTrackMimeType;
        ...
        OSCL_HeapString<PVMFEVRCParserNodeAllocator> iLogFile;
        bool oFormatSpecificInfoLogged;

        OsclSharedPtr<PVLoggerAppender> iBinAppenderPtr;
};

class PVMFEVRCFFParserOutPort : public PvmfPortBaseImpl
            , public PvmiCapabilityAndConfig
{
    public:
         ...
         */
        PVMFEVRCFFParserOutPort(int32 aTag
    ...
    private:
        ...
        PVMFEVRCFFParserNode* iEVRCParserNode;
};

#endif // PVMF_EVRCFFPARSER_OUTPORT_H_INCLUDED
