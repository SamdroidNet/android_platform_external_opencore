...
// Macros for EVRC Encoder
#define EVRC_MINBITRATE	0.8		// for eight framerate : bitrate is 0.8 kbps
#define EVRC_MAXBITRATE 8.55	// for full framerate: bitrate is 8.55 kbps
...
#if 1
#define DEFAULT_OMX_MP4ENC_QPI 10
#define DEFAULT_OMX_MP4ENC_QPP (DEFAULT_OMX_MP4ENC_QPI)
#define DEFAULT_OMX_MP4ENC_QPB (DEFAULT_OMX_MP4ENC_QPI)
#else
...
//	OSCL_IMPORT_REF bool queryInterface(const PVUuid& uuid, PVInterface*& iface);
    ...
    private:
		...
		bool SetG711EncoderParameters();
		bool SetEVRCEncoderParameters();
		bool SetG729EncoderParameters();
		bool SetMP3EncoderParameters();
